...
frasesStemmingTeste = aplicarStemmer(baseTeste)
...
palavrasTeste = buscaPalavras(frasesStemmingTeste)
# print(palavras)
...
# Mostra as caracteríticas mais informativas
...
novoRegistro = extratorPalavras(testeStemming)

# print(novoRegistro)

# print("\nClasse:",classificador.classify(novoRegistro),"\n")
